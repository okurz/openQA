...
packages and add the paths of those files to `assets/entry/` as needed for
new entry points, or import them in existing entry points like
`assets/entry/bootstrap.js` or `assets/entry/bootstrap.scss`.
Vite 8 is used to bundle these assets.
