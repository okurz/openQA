...
# TODO try to extract that into a separate test module
subtest 'Cache tests' => sub {
    ...
    for (1 .. $cache_service_timeout) {
        ...
        note "Waiting for cache service to be available under $supposed_cache_service_host, try $_";
        sleep 1;
    }
    ...
    for (1 .. $cache_worker_timeout) {
        ...
        note "Waiting for cache service worker to be available, try $_";
        sleep 1;
    }
