...
test-unit-and-integration:
	...
	RETRY=${RETRY} STABILITY_TEST=1 HOOK=./tools/delete-coverdb-folder TEST_PG="DBI:Pg:dbname=openqa_test;host=$(TEST_PG_PATH)" timeout -s SIGINT -k 5 -v ${TIMEOUT_RETRIES} tools/retry prove ${PROVE_LIB_ARGS} ${PROVE_ARGS}
